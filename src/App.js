...
function Search({ handlePostFiltering }) {
  ...
  function handleSearchChange(e) {
    ...
    handlePostFiltering(e.target.value.toLowerCase());
  }
      ...
      <form onSubmit={(e) => e.preventDefault()}>
        <div className="container py-3 py-xxl-4">
          <div className="row">
            ...
            <div className="col">
              <input id="searchBar" className="form-control" name="searchBar" type="text" value={searchTerm} onChange={handleSearchChange} />
            </div>
            <div className="col-auto">
              <button type="button" className="btn btn-warning" onClick={handleSearchCancel}>Cancel</button>
            </div>
          </div>
        </div>
      </form>
...
function PostCard({
  ...
  return (
    <div className="col-12 col-md-6">
      <div className="card">
        <img src={postImages[normalizedLocation]} className="card-img-top post-image-height object-fit-cover" alt="..." />
...
////The aside that holds a list of locations with how many post where made for it
